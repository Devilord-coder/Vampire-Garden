...
class MainMapView(arcade.View):
    '''Вид создания главной карты игры'''
    def __init__(self, window):
        super().__init__()
        arcade.set_background_color(arcade.color.ANTIQUE_RUBY)
        self.buildings = {'library': 'resources/Buildings/library.png', 'bat_house': 'resources/Buildings/bat_house.png', 'main_house': 'resources/Buildings/main_house.png', 'sport_hall': 'resources/Buildings/sport_hall.png', 'sceleton_house': 'resources/Buildings/sceleton_house.png', 'portal': 'resources/Portal/portal1.png', 'vampire_house': 'resources/Buildings/vampire_house.png', 'werewolf_house': 'resources/Buildings/werewolf_house.png', 'garden': 'resources/Buildings/garden.png'}
        self.window = window
        self.batch = Batch()
    ...
    def center_map(self):
        # Центрирование карту относительно окна
